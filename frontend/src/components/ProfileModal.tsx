...
export default function ProfileModal({ profile, username, onClose }: ProfileModalProps) {
  return (
              ...
              <details className="group">
                ...
                <div className="mt-3 relative">
                  <button
                    ...
                    className="absolute top-2 right-2 px-2 py-1 text-[10px] font-medium bg-space-surface border border-space-border/50 rounded text-space-text-dim hover:text-space-accent hover:border-space-accent transition-colors"
                  >
                    Copy
                  </button>
